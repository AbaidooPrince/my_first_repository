...
public class Activity_Poster extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				switch (event.getActionMasked()){
  						...
  						case MotionEvent.ACTION_POINTER_UP: {
  							...
  							//do the action
  							Intent activity_main_news_intent = new Intent(Activity_Poster.this, Activity_MainNewsPage.class );
		...
		//Navigating from Trending to My profile
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				switch (event.getActionMasked()){
  						...
  						case MotionEvent.ACTION_POINTER_UP: {
  							...
  							//do the action
  							Intent activity_profile_intent = new Intent(Activity_Poster.this, Activity_MyProfile.class );
...
for(int x=0; x<3; x++) {
			...
			//because we are in the Activity_Post,
